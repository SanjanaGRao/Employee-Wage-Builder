...
public class EmpWageUC11 implements IComputeEmpWage {
	...
	public void computeEmpWage()
	{
		...
		{
			companyEmpWageArray[i].setTotalEmpWage(this.computingEmpWage(companyEmpWageArray[i]));
	...
	public static void main(String[] args) {
		EmpWageUC11 employeeWageBuilder =new EmpWageUC11();
